...
internal static class Program
{
    ...
    private static int Main()
    {
        try
        {
            ...
            Console.WriteLine("Motor path runner input: " + rawPath);
            Console.WriteLine("Motor path runner expanded: " + path);
                ...
                switch (state)
                {
                    case State.LoadCommand:
                        if (commandIndex >= path.Length)
                        {
                            ...
                            Console.WriteLine("Motor path runner finished.");
                            state = State.Done;
                            break;
                        }
        ...
        {
            Console.WriteLine("c_path_runner failed: " + ex);
            return 1;
        }
    }
